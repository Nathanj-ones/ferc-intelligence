...
print()
print("=" * 100)
print("REAL PENDING REGULATORY ACTION TEST")
print("=" * 100)
print()
print(
    f"Project: {PROJECT}"
...
# ==============================================================
# BUILD REAL PENDING REGULATORY ACTIONS
# ==============================================================

pending_actions = find_pending_regulatory_actions(
    classified_filings
)

print()
print("=" * 100)
print("PENDING REGULATORY ACTIONS")
print("=" * 100)

if not pending_actions:
    print()
    print("No pending regulatory actions identified.")
else:
    for action in pending_actions:
        print()
        print("Gate:", action.gate)
        print("Status:", action.status)
        print(
            "Initiating filing:",
            action.initiating_accession,
        )
        print(
            "Initiating party:",
            action.initiating_party,
        )
        if action.initiating_date:
            print(
                "Initiating date:",
                action.initiating_date.strftime(
                    "%Y-%m-%d"
                ),
            )
        print(
        ...
        if action.requested_timing:
            print(
                "Requested timing:",
                action.requested_timing.strftime(
                    "%Y-%m-%d"
                ),
            )
            print(
            ...
            print(
                "Requested timing: not established"
            )
        print(
            "Expected resolution:",
        ...
        print(
            "Blocking next stage:",
            action.blocking_next_stage,
        )
        print(
            "Timeline signal:",
            action.timeline_signal,
        )
        print(
            "Confidence:",
            action.confidence,
...
print()
print(
    "PASS | Real-project pending-action analysis generated"
)
